...
//         document.getElementById('successMessage').textContent = "Cambios realizados con éxito.";
//     } else {
//         alert(message);
//         document.getElementById('successMessage').textContent = "Inténtalo nuevamente.";
//     }
